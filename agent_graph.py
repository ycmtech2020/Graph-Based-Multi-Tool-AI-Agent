...
#             ("system", """You are a helpful, graph-based AI assistant. 
#              Answer the user's question based on the provided context (from RAG, Wikipedia, or OCR) and chat history.
#              If the context is irrelevant or not provided, answer based on your general knowledge.For OCR provide only meaningfull answer not noisy and meaningless text.
...
# class RouteQuery(BaseModel):
#     """Route a user query to the most relevant tool/datasource."""
#     datasource: Literal["multi_file_rag", "wiki_search", "ocr_tool", "rag_chat"]  = Field(
#         ...,
#         description=(
#             "Given a user question, choose to route it to:\n"
#             "1. 'multi_file_rag': For questions about uploaded PDF, CSV, Word content.\n"
#             "2. 'wiki_search': For general knowledge or real-time info.\n"
#             "3. 'ocr_tool': For extracting text from images (OCR).\n"
#             "4. 'rag_chat': For follow-up conversational query."
#         )
#     )
...
#         print("---ROUTE TO WIKI SEARCH---")
#         return "wiki_search"
#     elif source.datasource == "multi_file_rag":
